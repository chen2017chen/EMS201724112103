<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EMS201724112103.Default" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <lable for="txtName">账号</lable><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="账号或密码错误！" ControlToValidate="id" Display="Dynamic"></asp:RequiredFieldValidator>
